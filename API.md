...
| <code><a href="#cdk-encrypted-secret.EncryptedSecret.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-encrypted-secret.EncryptedSecret.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-encrypted-secret.EncryptedSecret.with.parameter.mixins"></a>
